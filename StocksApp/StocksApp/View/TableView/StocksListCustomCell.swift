...
final class StocksListCustomCell: UITableViewCell {
...
extension StocksListCustomCell {
    ...
    func set(cell: StockModel) {
        ...
        if cell.positiveChange {
            changeInPriceLabel.textColor = .systemGreen
        } else {
            changeInPriceLabel.textColor = .red
        }
...
private extension StocksListCustomCell {
